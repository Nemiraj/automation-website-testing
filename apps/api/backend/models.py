...
class PageInfo(BaseModel):
    ...
    healthStatus: Literal['HEALTHY', 'WARNING', 'FAILED'] = 'HEALTHY'
...
class SiteMapNode(BaseModel):
    ...
    path: str
    title: str
    status: Literal['HEALTHY', 'WARNING', 'FAILED'] = 'HEALTHY'
...
class TestStep(BaseModel):
    id: str
    order: int
    action: Literal['navigate', 'click', 'fill', 'select', 'check', 'uncheck', 'submit', 'wait', 'assert_text', 'assert_url', 'assert_visible']
...
class TestCase(BaseModel):
    ...
    name: str
    description: str
    category: Literal['authentication', 'user_journey', 'form', 'search', 'navigation', 'buttons', 'responsive', 'performance']

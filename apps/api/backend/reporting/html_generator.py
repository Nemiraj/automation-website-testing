        ...
        if failed_results:
            ...
            for res in failed_results:
                ...
                <div class="failure-card">
                  ...
                  <div style="background: rgba(15, 23, 42, 0.6); padding: 14px; border-radius: 8px; margin-top: 12px;">
                    <div style="font-size: 13px; font-weight: 700; color: #38bdf8; margin-bottom: 6px;">🤖 AI Diagnosis & Recommended Action:</div>
                    <div style="font-size: 13px; color: #e2e8f0;">{inv.aiAnalysis.likelyCause}</div>
                    <div style="font-size: 12px; color: #94a3b8; margin-top: 6px;">Recommended Investigation: {investigations_str}</div>
                  </div>
                </div>
                """
